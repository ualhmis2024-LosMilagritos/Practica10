...
//			driver = new HtmlUnitDriver(BrowserVersion.CHROME, true);
	...
	public void loginCorrecto() {
		...
		// 5-7 | click | css=.font-semibold |
		for (int i = 0; i < 3; i++) {
			WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".font-semibold")));
			element.click();
		}

		// 8 | assertText | css=.font-semibold | webDinamica
		WebElement resultElement = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(".font-semibold")));
		assertThat(resultElement.getText(), is("webDinamica"));
	}
}
